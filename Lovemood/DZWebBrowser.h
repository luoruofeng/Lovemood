 ...
 */
@interface DZWebBrowser : UIViewController <UIWebViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UIGestureRecognizerDelegate>


@property (nonatomic, strong) UIView *activityBlockView;
